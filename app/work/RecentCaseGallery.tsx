...
const recentCases: RecentCase[] = [
  ...
  },
  {
    ...
    label: "本地可复现执行",
    summary: "脱敏询盘 → 结构化需求 → 检索与验证 → 报价草案与本地 CRM 草案。",
    detail: "服务端使用脱敏样例真实创建运行记录与产物；未连接客户邮箱、ERP、CRM 或对外发送。",
  ...
  },
  {
    ...
    label: "本地可复现执行",
    summary: "脱敏企业微信线索 → 顾问预评估 → 人工确认 → 本地建案草案。",
    detail: "服务端使用脱敏线索真实创建运行记录与建案草案；未连接客户企业微信、案件系统或对外发送。",
